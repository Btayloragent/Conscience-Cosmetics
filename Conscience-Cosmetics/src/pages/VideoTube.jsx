...
    return (
      <div className="text-white text-center mt-10" style={{ fontFamily: "Merriweather, serif" }}>
        Loading video...
      </div>
    );
  }
...
  return (
    <div className="min-h-screen bg-black p-4 flex justify-center" style={{ fontFamily: "Merriweather, serif" }}>
